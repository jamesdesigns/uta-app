...
//         marker = mapView.findMarker((marker) => {
...
//         return wait(3000);
//     }).then(() => {
//         const marker = mapView.findMarker((marker) => {
//             return marker.userData.index === 2;
//         });
//         marker.visible = true;
...
//         return wait(3000);
//     }).then(() => {
//         const marker = mapView.findMarker((marker) => marker.userData.index === 2);
...
//         return wait(3000);
//     }).then(() => {
//         const marker = mapView.findMarker((marker) => marker.userData.index === 1);
